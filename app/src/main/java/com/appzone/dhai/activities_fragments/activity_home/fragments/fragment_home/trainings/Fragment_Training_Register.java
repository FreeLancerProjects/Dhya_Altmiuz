...
public class Fragment_Training_Register extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_training_register,container,false);
        initView(view);
        return view;
    }
    ...
    private void CheckData() {
                ...
                )
        {
            ...
            activity.trainingRegister(m_name,m_phone,m_email,m_add_info,m_description,m_notes);
